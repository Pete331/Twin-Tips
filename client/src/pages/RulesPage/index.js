      ...
      <Container>
        <div>
          ...
          <ul>
            ...
            <li style={bullet}>
              Select the winning margin in the game of your choice (Either from
              the Top 8 team selection or the Bottom 10 team selection – Not
              both).
            </li>
            <li style={bullet}>
            ...
            <li style={bullet}>
              A drawn match is equivalent to half a win. (1 win and a draw will
              always beat 1 win).
            </li>
          </ul>
          <ul>
            ...
            <li style={bullet}>
              Players pay 5 points per round to play; this goes into the weekly
              points pool (If ten people in your league submit their tips, the
              weekly pool will have 50 points in it).
            </li>
            <li style={bullet}>
